...
export * from './decision-intelligence' // Decision intelligence — Ch 5.1-5.11: signal generation → strategy intelligence → portfolio construction → risk management → position sizing → order decision → execution optimization → smart order routing → broker gateway → exchange execution → post-trade reconciliation: Canonical Reconciliation Contract, 20-stage pipeline, 12 reconciliation types, three-way trade matching (Rule 6/13/15), execution verification (Rule 10), exception management + contra-reconciliation (Rule 21/22), pending settlement escrow (§10A, Rule 9/12/19), versioning, governance
