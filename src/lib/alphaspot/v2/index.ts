...
export * from './decision-intelligence' // Decision intelligence — signal generation (Chapter 5.1) + strategy intelligence engine (Ch 5.2) + portfolio construction engine (Ch 5.3) + risk management engine (Ch 5.4) + position sizing engine (Ch 5.5) + order decision engine (Ch 5.6) + execution optimization engine: Canonical Execution Plan Contract, 19-stage pipeline, 12 execution algorithms (TWAP/VWAP/POV/IS/Iceberg/Sniper/etc.), child order decomposition (Rule 8), residual re-absorption state machine (Rule 21), execution adaptation + algorithm switching (Rule 22/23/26), execution footprint randomization (Rule 24/25), versioning, governance (Chapter 5.7)
