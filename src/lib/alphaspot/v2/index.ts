...
export * from './decision-intelligence' // Decision intelligence — Ch 5.1-5.12: signal generation → strategy intelligence → portfolio construction → risk management → position sizing → order decision → execution optimization → smart order routing → broker gateway → exchange execution → post-trade reconciliation → portfolio accounting: Canonical Portfolio Accounting Contract, 13-stage pipeline, double-entry bookkeeping (Rule 9/17), bi-temporal accounting (§4A), 8 ledgers, compensating journals (§7A, Rule 21), bifurcated positions (§10A, Rule 22), short financing (§11A, Rule 23), cost basis (§8, Rule 11), tax lots (§9), multi-currency (§11, Rule 13), corporate actions (§12, Rule 12), versioning, governance
