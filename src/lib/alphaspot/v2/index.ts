...
export * from './decision-intelligence' // Decision intelligence — Ch 5.1-5.10: signal generation → strategy intelligence → portfolio construction → risk management → position sizing → order decision → execution optimization → smart order routing → broker gateway → exchange execution: Canonical Execution Event Contract, 14-stage pipeline, 15 execution states, 16 exchange events, asynchronous sequence buffer (Rule 6/21), fill aggregation (Rule 9/10), trade bust/correction (Rule 22), gap-recovery mode (Rule 23), versioning, governance
