...
export * from './decision-intelligence' // Decision intelligence — signal generation (Chapter 5.1) + strategy intelligence engine: Canonical Strategy Decision Contract, 11-stage pipeline, multi-strategy coordination/reconciliation, lifecycle state management, versioning, governance (Chapter 5.2) + portfolio construction engine: Canonical Portfolio Contract, 15-stage pipeline, 17 optimization methodologies, diversification/correlation assessment, rebalancing delta, versioning, governance (Chapter 5.3) + risk management engine: Canonical Risk Contract, 16-stage pipeline, 12 risk categories, 8 stress test methodologies, atomic dependency verification (Rule 15/23), pre-trade margin simulation (Rule 21), transactional limits (Rule 22), circuit breakers (Rule 16), versioning, governance (Chapter 5.4) + position sizing engine: Canonical Position Contract, 17-stage pipeline, 12 sizing methods, atomic capital locking (Rule 21), capital reservation (Rule 13/17/24), exchange normalization (Rule 10/16/19), hard caps (Rule 23), price/FX oracle (Rule 22), versioning, governance (Chapter 5.5) + order decision engine: Canonical Order Intent Contract, 21-stage pipeline, rebalancing thresholds (Rule 6), transaction cost/market impact/liquidity evaluation (Rule 9/10/11), pending order freshness + stale recovery (Rule 21), temporal cooldowns (Rule 22), execution urgency (Rule 23), turnover budget (Rule 17), validity horizon (Rule 14), versioning, governance (Chapter 5.6)
