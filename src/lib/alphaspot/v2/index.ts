...
export * from './decision-intelligence' // Decision intelligence — Ch 5.1 signal generation + Ch 5.2 strategy intelligence + Ch 5.3 portfolio construction + Ch 5.4 risk management + Ch 5.5 position sizing + Ch 5.6 order decision + Ch 5.7 execution optimization + Ch 5.8 smart order routing: Canonical Routing Contract, 15-stage pipeline, 10 routing strategies, venue evaluation + toxicity assessment (Rule 21), multi-venue allocation + latency-matched sync (Rule 22/23), failover + isolation (Rule 13), dynamic queue management + rerouting (Rule 24/25/26), versioning, governance
